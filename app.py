...
def get_api_key():
    try:
        if "KOREA_API_KEY" in st.secrets:
            return st.secrets["KOREA_API_KEY"]
    except:
        pass
...
if not final_api_key:
    st.error("🚨 서버 비밀 금고 또는 로컬 api_key.txt에 API 키가 설정되지 않았습니다! 관리자에게 문의하세요.")
    st.stop()
...
SEOUL_DONG_DB = {
    ...
    "성동구": ["금호동1가", "금호동2가", "금호동3가", "금호동4가", "도선동", "마장동", "사근동", "상왕십리동", "성수동1가", "성수동2가", "송정동", "옥수동", "용답동", "응봉동", "하왕십리동", "홍익동"],
    "성북구": ["길음동", "돈암동", "동선동1가", "동선동2가", "동선동3가", "동선동4가", "동소문동1가", "동소문동2가", "동소문동3가", "동소문동4가", "동소문동5가", "동소문동6가", "동소문동7가", "보문동1가", "보문동2가", "보문동3가", "보문동4가", "보문동5가", "보문동6가", "보문동7가", "삼선동1가", "삼선동2가", "삼선동3가", "삼선동4가", "삼선동5가", "상월곡동", "석관동", "성북동", "성북동1가", "안암동1가", "안암동2가", "안암동3가", "안암동4가", "안암동5가", "장위동", "정릉동", "종암동", "하월곡동"],
    ...
    "종로구": ["가회동", "견지동", "결동", "계동", "공평동", "관수동", "관철동", "관훈동", "교남동", "교북동", "구기동", "궁정동", "권농동", "낙원동", "내수동", "내자동", "누상동", "누하동", "당주동", "돈의동", "동숭동", "명륜1가", "명륜2가", "명륜3가", "명륜4가", "묘동", "무악동", "봉익동", "부암동", "사직동", "삼청동", "서린동", "세종로", "소격동", "송월동", "송현동", "수송동", "숭인동", "신교동", "신문로1가", "신문로2가", "신영동", "안국동", "연건동", "연지동", "예지동", "옥인동", "와룡동", "운니동", "원남동", "원서동", "이화동", "익선동", "인사동", "인의동", "장사동", "재동", "적선동", "종로1가", "종로2가", "종로3가", "종로4가", "종로5가", "종로6가", "중학동", "창성동", "창신동", "청운동", "청진동", "체부동", "충신동", "통의동", "통인동", "팔판동", "평창동", "평동", "필운동", "행촌동", "혜화동", "홍파동", "화동", "효자동", "효제동", "훈정동"],
...
VIP_APARTMENT_DB = {
    ...
    # 💡 브라이튼 여의도 정답지 추가 (네이버 부동산 면적 기준 완벽 일치)
    "여의도동_브라이튼여의도": {84.13: 117.27, 101.95: 140.59, 113.96: 155.08, 115.88: 158.0, 115.98: 158.0, 117.33: 159.83, 132.59: 179.31, 134.86: 182.0, 134.92: 182.0, 135.93: 183.0},
    "여의도동_브라이튼여의도(주상복합)": {84.13: 117.27, 101.95: 140.59, 113.96: 155.08, 115.88: 158.0, 115.98: 158.0, 117.33: 159.83, 132.59: 179.31, 134.86: 182.0, 134.92: 182.0, 135.93: 183.0},
    # 💡 타워팰리스 1차 정답지 추가 (네이버 부동산 면적 기준 완벽 일치)
    "도곡동_타워팰리스1": {78.99: 105.0, 84.15: 112.53, 84.16: 112.98, 120.78: 161.42, 121.42: 162.0, 137.24: 183.52, 164.95: 233.27, 222.48: 297.0, 244.66: 327.0},
    "도곡동_타워팰리스1차": {78.99: 105.0, 84.15: 112.53, 84.16: 112.98, 120.78: 161.42, 121.42: 162.0, 137.24: 183.52, 164.95: 233.27, 222.48: 297.0, 244.66: 327.0}
}
